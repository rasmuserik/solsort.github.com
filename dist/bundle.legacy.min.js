...
bundler.module('scripts/main.js','var Backbone=require("backbone"),jsxml=require("jsxml"),console=require("console"),$=require("zquery"),fullbrows=require("fullbrows"),SiteMap=Backbone.Router.extend({routes:{menu:"menu",bidiv:"bidiv",unicodeTest:"unicodeTest","notes/*path":"notes","source/*path":"source",timelog:"timelog",plasma:"diamondsquare",combigame:"combigame","*default":"default"},"default":function(){},unicodeTest:unicodeTest,timelog:require("timelog").main,menu:menuFn,combigame:fullbrows.startFn(require("combigame").app),bidiv:fullbrows.startFn(require("bidiv").app),diamondsquare:fullbrows.startFn(require("demoPlasma").app),source:function(name){require("showSource").show(name)},html:function(name){},notes:notes});function unicodeTest(){var t=[],i,n=65538;$("body").text("");for(i=0;i<n;++i)t.push(i);t=t.map(function(a){return String.fromCharCode(a)}),t=t.join("");for(i=0;i<n;++i)t.charCodeAt(i)!==i&&$("body").append("error t["+i+"] -> "+t.charCodeAt(i)+"<br>");$("body").append("done")}function notes(fnname){var showdown;showdown=require("showdown"),showdown=new showdown.converter,console.log(showdown),$.get("notes/"+fnname+".md",function(text){var html=showdown.makeHtml(text);fullbrows.start({type:"scrollable",update:function(){$("#content").html(html)}})})}var sitemap=new SiteMap;exports.main=function(){$(function(){Backbone.history.start(),$("#content").length||$("body").append(\x27<div id="content"></div>\x27)})};function menuFn(){fullbrows.start({update:function(){$("#content").html(jsxml.toDOM(menuXml)),fullbrows.start(require("./menu").createApp($("#content > ul > li")[0]))}})}var menuXml=["ul",["li","solsort.dk",["ul",["li",["a",{href:"/CurriculumVitae.html"},"CV"]],["li","Apps",["ul",["li",["a",{href:"/dkcities"},"Danskebyer"]],["li",["a",{href:"/notescore"},"notescore"]],["li",["a",{href:"/planetcute"},"PlanetCute"]]]],["li","Notes",["ul",["li",["a",{href:"/notes/tekststruktur-for-rapporter.html"},"Tekststruktur for rapporter"]],["li",["a",{href:"/notes/tommelfingerregler-for-skrivning.html"},"Tommelfingerregler for skrivning"]],["li",["a",{href:"/notes/fototips.html"},"Fototips"]],["li","Tech",["ul",["li",["a",{href:"/notes/tech/c9ender.html"},"Cloud9 and Ender"]],["li",["a",{href:"/notes/tech/jekyll.html"},"Jekyll / github-pages"]],["li",["a",{href:"/notes/tech/vim.html"},"vim"]],["li",["a",{href:"/notes/tech/coffee.html"},"CoffeeScript"]]]],["li",["a",{href:"/notes/ted.html"},"TED talks"]]]],["li","JS",["ul",["li",["a",{href:"/devintro/book.html"},"devintro"]],["li","1k",["ul",["li",["a",{href:"/f1k/blah.html"},"4d juliabrot"]],["li",["a",{href:"/f1k/rain.html"},"rain"]]]],["li","tweetsize",["ul",["li",["a",{href:"/f1k/brown.html"},"brownian motion"]],["li",["a",{href:"/f1k/sierpinsky.html"},"sierpinsky"]]]],["li","\u201ciOS style\u201d:"],["li","\u201chierachical layout\u201d:"],["li","\u201cslidein transitions\u201d:"]]],["li","Presentations",["ul",["li",["a",{href:"/presentations/oauth2.html"},"OAuth2"]]]]]]]');
...
bundler.module('scripts/fullbrows.js','var util=require("util"),webutil=require("webutil"),$=require("zquery"),window=require("window"),Modernizr=require("modernizr"),relayoutFn,browsOpt={};function relayout(){$("#content").css("position","absolute").css("left",0).css("top",1).css("overflow","hidden").css("font-family","sans-serif").css("width","100%").css("height",browsOpt.type==="scrollable"?"auto":webutil.windowHeight()),typeof relayoutFn=="function"&&relayoutFn(window.document.getElementById("content")),window.scrollTo(0,1)}var relayoutDelayed=util.niceSingle(relayout);exports.start=function(opt){typeof browsOpt.stop=="function"&&browsOpt.stop(),browsOpt=opt||{},browsOpt.type=browsOpt.type||"fullscreen",$("#content").remove(),browsOpt.type==="canvas"?(console.log("a"),$("body").append(\x27<canvas id="content">Error: canvas not supported, please update to a modern browser.</canvas>\x27)):(console.log("b"),$("body").append(\x27<div id="content"></div>\x27)),Modernizr.touch?($("#addressbarfillerdisable").remove(),$("body").append(\x27<div id="addressbarfillerdisable" style="height:\x27+(Math.max(webutil.windowHeight(),$(window).width())+62)+\x27px;"></div>\x27)):browsOpt.type==="scrollable"?$("body").css("overflow","auto"):$("body").css("overflow","hidden"),$(window).bind("resize",relayoutDelayed),$(window).bind("orientationchange",relayoutDelayed),relayoutFn=browsOpt.start||browsOpt.update,relayout(),relayoutFn=browsOpt.update},exports.startFn=function(app){return console.log(1),function(){console.log(2),exports.start(app)}}');

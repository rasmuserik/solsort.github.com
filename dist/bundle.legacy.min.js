...
bundler.module('scripts/fullbrows.js','var util=require("util"),webutil=require("webutil"),$=require("zquery"),window=require("window"),Modernizr=require("modernizr"),app={};function relayoutStyle(){$("#content").css("position","absolute").css("left",0).css("top",1).css("overflow","hidden").css("font-family","sans-serif").css("width","100%").css("height",app.type==="scrollable"?"auto":webutil.windowHeight()),window.scrollTo(0,1)}function relayout(){relayoutStyle(),typeof app.update=="function"&&app.update()}var relayoutDelayed=util.niceSingle(relayout),isMobile=!!window.navigator.userAgent.match(/mobile/i);exports.start=function(opt){typeof app.stop=="function"&&app.stop(),app=opt||{},app.type=app.type||"fullscreen",app.mobile===undefined&&(app.mobile=isMobile),alert("mobile: "+app.mobile),$("#content").remove(),app.type==="canvas"?$("body").append(\x27<canvas id="content">Error: canvas not supported, please update to a modern browser.</canvas>\x27):$("body").append(\x27<div id="content"></div>\x27),app.$=$("#content"),app.elem=app.$[0],Modernizr.touch?($("#addressbarfillerdisable").remove(),$("body").append(\x27<div id="addressbarfillerdisable" style="height:\x27+(Math.max(webutil.windowHeight(),$(window).width())+62)+\x27px;"></div>\x27)):app.type==="scrollable"?$("body").css("overflow","auto"):$("body").css("overflow","hidden"),$(window).bind("resize",relayoutDelayed),$(window).bind("orientationchange",relayoutDelayed),app.start=app.start||app.update,relayoutStyle(),app.start()},exports.startFn=function(app){return console.log(1),function(){console.log(2),exports.start(app)}}');

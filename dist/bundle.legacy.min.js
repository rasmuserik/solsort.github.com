...
bundler.module('scripts/fullbrows.js','var util=require("util"),webutil=require("webutil"),$=require("zquery"),window=require("window"),Modernizr=require("modernizr"),app={};function l(e){return console.log(e),e}function relayoutStyle(){var lbar=$(window).width()>$(window).height(),barsize=app.mobile?8:8;$("#bar").css({position:"absolute",left:"0px",top:"0px",margin:0,padding:0,textAlign:"center",overflow:"visible",width:lbar?barsize+"%":"100%",height:lbar?"100%":barsize+"%"}).html(\x27<img class="barleft" src="img/help.png"> <img class="barleft" src="img/difficulty.png"> <img class="barright" src="img/score.png">\x27);var iconsize=lbar?$("#bar").width():$("#bar").height();$("#bar img").css({width:iconsize*.6,height:iconsize*.6,boxShadow:"3px 3px 9px rgba(0, 0, 0, .4)",webkitBoxShadow:"3px 3px 9px rgba(0, 0, 0, .4)",background:"rgba(255,255,255,.9)",verticalAlign:"top",padding:iconsize*.1,border:"1px solid black",borderRadius:iconsize*.2,marginLeft:iconsize*.1,marginBottom:iconsize*.1,marginRight:iconsize*.1,marginTop:iconsize*.1}),$("#bar").css("position","fixed"),$(".barleft").css("float","left"),$(".barright").css("float","right"),$("#content").css("position","absolute").css("left",lbar?barsize+"%":0).css("top",lbar?1:barsize+"%").css("overflow","hidden").css("width",lbar?100-barsize+"%":"100%").css("padding-bottom",1).css("height",app.type==="scrollable"?"auto":lbar?"100%":100-barsize+"%"),window.scrollTo(0,1)}function relayout(){relayoutStyle(),typeof app.update=="function"&&app.update(),window.scrollTo(0,1)}var relayoutDelayed=util.niceSingle(relayout),isMobile=window.isMobile||!!window.navigator.userAgent.match(/mobile/i);exports.start=function(opt){typeof app.stop=="function"&&app.stop(),app=opt||{},app.type=app.type||"fullscreen",app.mobile===undefined&&(app.mobile=isMobile),$("#content").remove(),app.type==="canvas"?$("body").append(\x27<canvas id="content">Error: canvas not supported, please update to a modern browser.</canvas>\x27):$("body").append(\x27<div id="content"></div>\x27),$("#bar").remove(),$("body").append(\x27<div id="bar"></div>\x27),app.$=$("#content"),app.elem=app.$[0],Modernizr.touch?($("#addressbarfillerdisable").remove(),$("body").append(\x27<div id="addressbarfillerdisable" style="height:\x27+(Math.max(webutil.windowHeight(),$(window).width())+62)+\x27px;"></div>\x27)):app.type==="scrollable"?$("body").css("overflow","auto"):$("body").css("overflow","hidden"),$(window).bind("resize",relayoutDelayed),$(window).bind("orientationchange",relayoutDelayed),app.start=app.start||app.update,relayoutStyle(),app.start()},exports.startFn=function(app){return console.log(1),function(){console.log(2),exports.start(app)}}');

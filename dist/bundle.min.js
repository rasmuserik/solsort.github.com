...
bundler.module('scripts/fullbrows.js','var util=require("util"),webutil=require("webutil"),$=require("zquery"),window=require("window"),Modernizr=require("modernizr"),relayoutFn,browsOpt={};function relayout(){$("#content").css("position","absolute").css("left",0).css("top",1).css("overflow","hidden").css("font-family","sans-serif").css("width",$(window).width()).css("height",browsOpt.type==="scrollable"?"auto":webutil.windowHeight()),typeof relayoutFn=="function"&&relayoutFn(window.document.getElementById("content")),window.scrollTo(0,1)}var relayoutDelayed=util.niceSingle(relayout);exports.start=function(opt){typeof browsOpt.stop=="function"&&browsOpt.stop(),browsOpt=opt||{},browsOpt.type=browsOpt.type||"fullscreen",window.document.getElementById("content")||$("body").append(\x27<div id="content"></div>\x27),Modernizr.touch?$("#addressbarfillerdisable").length===0&&$("body").append(\x27<div id="addressbarfillerdisable" style="height:\x27+(Math.max(webutil.windowHeight(),$(window).width())+62)+\x27px;"></div>\x27):$("body").css("overflow","hidden"),$(window).bind("resize",relayoutDelayed),$(window).bind("orientationchange",relayoutDelayed),relayoutFn=browsOpt.start||browsOpt.update,relayout(),relayoutFn=browsOpt.update},exports.startFn=function(app){return function(){exports.start(app)}}');

...
bundler.module('scripts/fullbrows.js','var util=require("util"),webutil=require("webutil"),$=require("zquery"),window=require("window"),Modernizr=require("modernizr"),app={};function l(e){return console.log(e),e}function relayoutStyle(){var vbar=$(window).width()>$(window).height(),barsize=app.mobile?16:8;$("#bar").css({position:"fixed",left:vbar?100-barsize+"%":"0px",top:"0px",margin:0,padding:0,overflow:"visible",width:vbar?barsize+"%":"100%",height:vbar?"100%":barsize+"%"});var iconsize=vbar?$("#bar").width():$("#bar").height(),barItemStyle={width:iconsize*.6,height:iconsize*.6,boxShadow:"0px 0px 32px rgba(255, 255, 255, 1), 2px 2px 14px rgba(0, 0, 0, .7)",webkitBoxShadow:"0px 0px 32px rgba(255, 255, 255, 1), 2px 2px 14px rgba(0, 0, 0, .7)",background:"rgba(255,255,255,1)",verticalAlign:"top",padding:iconsize*.1,borderRadius:iconsize*.2,marginLeft:iconsize*.1,marginBottom:iconsize*.1,marginRight:iconsize*.1,marginTop:iconsize*.1};$("#bar img").css(barItemStyle),$("#bar span").css(barItemStyle),$("#barleft img").css("float","left"),$("#barleft span").css("float","left"),$("#barright img").css("float","right"),$("#barright span").css("float","right"),vbar?($("#barright").css({width:iconsize,position:"fixed"}),$("#barright").css({position:"fixed",top:$("#bar").height()-$("#barright").height()})):$("#barright").css({position:"static",width:"auto",top:"auto"}),app.underbar&&(barsize=0,vbar=!0),$("#content").css("position","absolute").css("left",0).css("top",vbar?1:barsize+"%").css("overflow","hidden").css("width",vbar?100-barsize+"%":"100%").css("padding-bottom",1).css("height",app.type==="scrollable"?"auto":vbar?"100%":100-barsize+"%"),window.scrollTo(0,1)}function relayout(){relayoutStyle(),typeof app.update=="function"&&app.update(),window.scrollTo(0,1)}var relayoutDelayed=util.niceSingle(relayout),isMobile=window.isMobile||!!window.navigator.userAgent.match(/mobile/i);exports.start=function(opt){typeof app.stop=="function"&&app.stop(),app=opt||{},app.type=app.type||"fullscreen",app.mobile===undefined&&(app.mobile=isMobile),$("#content").remove(),app.type==="canvas"?$("body").append(\x27<canvas id="content">Error: canvas not supported, please update to a modern browser.</canvas>\x27):$("body").append(\x27<div id="content"></div>\x27),$("#bar").remove(),$("body").append(\x27<div id="bar"></div>\x27),$("#bar").html(\x27<div id="barleft"></div><div id="barright"></div>\x27),$("#barleft").append($(\x27<img src="img/home.png">\x27).on("mousedown touchstart",function(){return window.location.hash="#menu",!1})),window.location.hash.slice(0,7)==="#source"?$("#barleft").append($(\x27<img id="sourcebutton" src="img/sourcecode.png">\x27).on("mousedown touchstart",function(){return window.location.hash="#"+window.location.hash.slice(8),!1})):$("#barleft").append($(\x27<img id="sourcebutton" src="img/sourcecode.png">\x27).on("mousedown touchstart",function(){return window.location.hash="#source/"+window.location.hash.slice(1),!1})),app.$=$("#content"),app.elem=app.$[0],Modernizr.touch?($("#addressbarfillerdisable").remove(),$("body").append(\x27<div id="addressbarfillerdisable" style="height:\x27+(Math.max(webutil.windowHeight(),$(window).width())+62)+\x27px;"></div>\x27)):app.type==="scrollable"?$("body").css("overflow","auto"):$("body").css("overflow","hidden"),$(window).bind("resize",relayoutDelayed),$(window).bind("orientationchange",relayoutDelayed),$("body").css({webkitTransition:"background 1s",transition:"background 1s",background:"#fff"}),app.start=app.start||app.update,relayoutStyle(),app.start()},exports.startFn=function(app){return console.log(1),function(){console.log(2),exports.start(app)}}');
